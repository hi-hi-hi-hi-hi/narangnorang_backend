...
public class MiniroomController {
	...
	public String buy(@RequestBody Map<String, Object> paramMap,
			@AuthenticationPrincipal PrincipalDetails principalDetails) throws Exception {
	...
	public String wishupdate(@PathVariable("itemId") int itemId,
			@AuthenticationPrincipal PrincipalDetails principalDetails) throws Exception {
	...
	public int applyMiniroom(@AuthenticationPrincipal PrincipalDetails principalDetails,
